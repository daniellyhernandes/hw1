...
INSERT INTO movies_cast (id, movie_id, actor_id, character_name) VALUES
(1, 1, 1, 'Bruce Wayne'),
(2, 1, 2, 'Alfred'),
(3, 1, 3, 'Ra''s Al Ghul'),
(4, 1, 4, 'Rachel Dawes'),
...
SELECT movies.title, actors.name, movies_cast.character_name
FROM movies_cast
INNER JOIN actors ON actors.id = movies_cast.actor_id
